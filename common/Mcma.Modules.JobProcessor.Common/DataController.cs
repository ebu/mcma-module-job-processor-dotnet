...
namespace Mcma.Modules.JobProcessor.Common
{
    ...
    {
        public DataController(IDocumentDatabaseTable dbTable, IJobResourceQueryExecutor jobResourceQueryExecutor, IOptions<DataControllerOptions> options)
        {
            DbTable = dbTable ?? throw new ArgumentNullException(nameof(dbTable));
            JobResourceQueryExecutor = jobResourceQueryExecutor ?? throw new ArgumentNullException(nameof(jobResourceQueryExecutor));
        ...
        private IJobResourceQueryExecutor JobResourceQueryExecutor { get; }
        ...
        public async Task<QueryResults<Job>> QueryJobsAsync(JobResourceQueryParameters queryParameters, string pageStartToken = null)
            => await JobResourceQueryExecutor.QueryAsync(queryParameters, pageStartToken);
